...
$string['coursegradeserror'] = 'Warning: Grades will not be updated due an error on grade calculations. You have to solve the errors and then click \'Update grades\' to update calculations again';
