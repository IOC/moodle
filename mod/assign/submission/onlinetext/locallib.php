...
class assign_submission_onlinetext extends assign_submission_plugin {
    ...
    public function view_summary(stdClass $submission, & $showviewlink) {
        ...
        if ($onlinetextsubmission) {
            list($text, $portfoliohtml) = $this->assignment->render_editor_content(ASSIGNSUBMISSION_ONLINETEXT_FILEAREA,
    ...
    public function view(stdClass $submission) {
        ...
        if ($onlinetextsubmission) {
            ...
            list($result, $portfoliohtml) = $this->assignment->render_editor_content(ASSIGNSUBMISSION_ONLINETEXT_FILEAREA,
                                                                                     $onlinetextsubmission->submission,
                                                                                     $this->get_type(),
                                                                                     'onlinetext',
                                                                                     'assignsubmission_onlinetext');
