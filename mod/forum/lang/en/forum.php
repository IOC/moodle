...
$string['nofavdiscussionspermission'] = 'You do not have the permission to favourite discussions in this forum';
...
$string['showfavouritemessages'] = 'Show favourite messages ({$a})';
$string['showfavincontext'] = 'Show message in its context';
...
$string['togglefavourites'] = 'Toggle favourite posts';
