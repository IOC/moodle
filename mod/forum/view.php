...
/// Print settings and things across the top
    ...
    switch ($forum->type) {
        ...
        default:
            echo '<br />';
            if (!empty($showall)) {
                forum_print_latest_discussions($course, $forum, 0, 'header', 'd.pinned DESC', -1, -1, -1, 0, $cm, $showfavs);
            } else {
                forum_print_latest_discussions($course, $forum, -1, 'header', 'd.pinned DESC', -1, -1, $page, $CFG->forum_manydiscussions, $cm, $showfavs);
            }
