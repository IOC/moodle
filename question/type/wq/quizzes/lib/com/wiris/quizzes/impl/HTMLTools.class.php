...
class com_wiris_quizzes_impl_HTMLTools {
	...
	public function unitTestDev() {
		haxe_Log::trace("compare(a,a1)=" . _hx_string_rec(com_wiris_quizzes_impl_HTMLTools::compareStrings("a", "a1"), ""), _hx_anonymous(array("fileName" => "HTMLTools.hx", "lineNumber" => 1810, "className" => "com.wiris.quizzes.impl.HTMLTools", "methodName" => "unitTestDev")));
		...
		haxe_Log::trace("sort({a1,a})" . $r, _hx_anonymous(array("fileName" => "HTMLTools.hx", "lineNumber" => 1821, "className" => "com.wiris.quizzes.impl.HTMLTools", "methodName" => "unitTestDev")));
	}
