...
com_wiris_quizzes_impl_Assertion::$BASIC_UNITS_LIST = "m, s, g, A, K, mol, cd, rad, sr, h, min, l, N, Pa, Hz, W, J, C, V, " . com_wiris_quizzes_impl_Assertion_1() . ", F, S, Wb, b, H, T, lx, lm, Gy, Bq, Sv, kat";
com_wiris_quizzes_impl_Assertion::$CURRENCY_UNITS_LIST = "\$, " . com_wiris_quizzes_impl_Assertion_2() . ", " . com_wiris_quizzes_impl_Assertion_3() . ", " . com_wiris_quizzes_impl_Assertion_4() . ", kr, Fr, " . com_wiris_quizzes_impl_Assertion_5() . ", " . com_wiris_quizzes_impl_Assertion_6() . ", BTC";
com_wiris_quizzes_impl_Assertion::$ANGLE_UNITS_LIST = com_wiris_quizzes_impl_Assertion_7() . ", ', \"";
com_wiris_quizzes_impl_Assertion::$PERCENT_UNITS_LIST = "%, " . com_wiris_quizzes_impl_Assertion_8();
...
function com_wiris_quizzes_impl_Assertion_1() {
	{
		$s = new haxe_Utf8(null);
		$s->addChar(937);
		return $s->toString();
