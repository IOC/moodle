				...
				controller[0].setQuestionValue = (function(userAnswer,correctAnswer,paramName,assertionNames,elem) {
					return function(value) {
						...
						if(paramName[0] == "comma" || paramName[0] == "point" || paramName[0] == "space") {
							...
							var defDecimals = question.getAssertionIndex("syntax_quantity",0,userAnswer[0]) != -1?"', �":null;
					...
					return function(value) {
						...
						if(boolValue && StringTools.startsWith(assertionName[0],"syntax_")) {
							...
							if(assertionName[0] == "syntax_expression") {
								...
								visibleDivs = ["wirissyntaxconstants","wirissyntaxfunctions","wirissyntaxlist","wirissyntaxforcebrackets","wirissyntaxchars"];
